...
<head>
	...
	<link rel="stylesheet" href="<?=base_url()?>css/style_checkbox.css" type="text/css" media="screen" />
...
<body>
	<h1 id="logo">Tenancy Management System</h1>
	<div id="userbox">
		Welcome <?=$this->session->userdata('username')?>!<br />
